              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="validacionU.php" method="POST">
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <span class="h1 fw-bold mb-0">Welcome to Twins</span>
                  </div>
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block fa fa-address-book-o" type="submit" value="Iniciar Sesion"> LOG IN <i class="fa-regular fa-circle-user"></i> </button>
                  </div>

                  <p class="mb-5 pb-lg-2" style="color: #393f81;">You do not have an account? <a href="registro.php"
                      style="color: #393f81;">Register here</a></p>
                      <label class="checkbox-inline"><input type="checkbox" value=""> Accept Terms and Conditions </label>
                </form>
              </div>
            </div>
          </div>
