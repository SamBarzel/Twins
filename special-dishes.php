        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <div class="d-flex flex-lg-row flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="about.html">Encuentranos</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item" href="special-dishes.html">Mision</a>
                          <a class="dropdown-item" href="special-dishes.html">Vision</a>
                        </div>
                    </li>
                </div>
            </ul>
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                <div class="d-flex flex-lg-row flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="team.html">Especialidades</a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link" href="reservation.html">Pedidos</a>
                    </li>
                </div>
                <li class="nav-item">
